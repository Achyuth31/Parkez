...
function switchTab(tabName) {
    ...
    const menuMap = { parking: 'menu-parking-layout', analytics: 'menu-analytics', 'parked-list': 'menu-parked-list' };
...
function loginFacility(facilityId) {
    ...
    document.getElementById('header-facility-title').textContent = `${config.name} — Parking Operations`;
